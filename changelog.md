...
[All Commits](https://github.com/wardenenv/warden/compare/0.12.0..develop)

**Enhancements:**

* Updated environment default Node version from 10 to 12 (issue [#250](https://github.com/wardenenv/warden/issues/250))
* Default URL for ElasticsearchHQ is now configured in the docker-compose config ([#428](https://github.com/wardenenv/warden/pull/428) by @ihor-sviziev)
